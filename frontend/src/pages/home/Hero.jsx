    ...
    >
      <div className="w-full max-w-5xl px-6">
        <AnimatePresence mode="wait">
          ...
          >
            <p
              className={`text-xl md:text-2xl font-serif mb-4 text-left ${textColor}`}
            >
              {subheading}
            </p>
        ...
        <div className="mt-8 flex justify-end">
          ...
          >
            <span className="relative inline-block">
              ...
              {/* Thicker underline arrow */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 110 12" // taller and wider viewBox
                preserveAspectRatio="none"
                className="w-full h-3 mt-1" // increased height
              >
                <line
                  x1="0"
                  y1="6" // center line vertically
                  x2="100"
                  y2="6"
                  stroke="currentColor"
                  strokeWidth="6" // much thicker stroke
                  strokeLinecap="round"
                />
                <polygon
                  points="100,0 110,6 100,12" // much bigger arrowhead
                  fill="currentColor"
                />
              </svg>
            </span>
