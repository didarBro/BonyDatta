  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <div className="max-w-2xl mx-auto text-center mt-6 px-4">
        <p className="text-lg">
          Basically, if it falls under the Branding & Marketing umbrella, I’ve
          probably done it, fixed it, or made it better.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-12 px-4 pb-16">
        {services.map((service, index) => (
          <div key={index} className="text-center">
            <h3
              className="border-t-2 border-gray-200 inline-block mt-4 pt-2"
              style={{
      ...
      <div className="text-center mb-12">
        ...
        >
          Need a partner who gets the numbers and the narrative?
        </p>
